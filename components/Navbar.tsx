    ...
    <motion.nav
      ...
      <div className='container flex items-center justify-between m-auto px-4'>
        ...
        <div className='ml-auto text-lg pr-4 flex'>
          <button
            className='text-white text-2xl md:hidden mb-1'
            onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {isMenuOpen ? <FaTimes /> : <FaBars />}
          </button>
        ...
        <div className='flex items-center mb-1'>
          {isLoggedIn ? (
            ...
            <button
              onClick={() => setShowLoginPopup(true)}
              className='text-lg rounded-md hover:opacity-75 hover:text-red-500 mt-1'>
              Login
            </button>
          )}
        </div>
      ...
      {isMenuOpen && (
        <ul className='flex flex-col items-center justify-center mt-4 space-y-4 md:hidden'>
          <li>
            <Link
              legacyBehavior
              href='/'>
